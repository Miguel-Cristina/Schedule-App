...
Partial Public Class scheduleDataSet
    ...
    Partial Public Class ScheduleDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddScheduleRow(ByVal Name As String, ByVal Task As String, ByVal Subject As String) As ScheduleRow
            Dim rowScheduleRow As ScheduleRow = CType(Me.NewRow,ScheduleRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, Name, Task, Subject}
        ...
        Private Sub InitClass()
            ...
            Me.columnTask.MaxLength = 536870910
    ...
    Partial Public Class ScheduleRow
        ...
        Public Property Task() As String
            Get
                ...
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'Task' in table 'Schedule' is DBNull.", e)
                End Try
            End Get
            Set
        ...
        Public Function IsTaskNull() As Boolean
            Return Me.IsNull(Me.tableSchedule.TaskColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub SetTaskNull()
            Me(Me.tableSchedule.TaskColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace scheduleDataSetTableAdapters
    ...
    Partial Public Class ScheduleTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Schedule` WHERE ((`ID` = ?) AND ((? = 1 AND `Name` IS NULL) OR (`Nam"& _ 
                "e` = ?)) AND ((? = 1 AND `Subject` IS NULL) OR (`Subject` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Schedule` (`Name`, `Task`, `Subject`) VALUES (?, ?, ?)"
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Task", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Task", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Schedule` SET `Name` = ?, `Task` = ?, `Subject` = ? WHERE ((`ID` = ?) AND"& _ 
                " ((? = 1 AND `Name` IS NULL) OR (`Name` = ?)) AND ((? = 1 AND `Subject` IS NULL)"& _ 
                " OR (`Subject` = ?)))"
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OleDb.OleDbParameter("Task", Global.System.Data.OleDb.OleDbType.LongVarWChar, 0, Global.System.Data.ParameterDirection.Input, CType(0,Byte), CType(0,Byte), "Task", Global.System.Data.DataRowVersion.Current, false, Nothing))
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.StudentLoan.My.MySettings.Default.scheduleConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, Name, Task, Subject FROM Schedule"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_Name As String, ByVal Original_Subject As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Name As String, ByVal Task As String, ByVal Subject As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal Name As String, ByVal Task As String, ByVal Subject As String, ByVal Original_ID As Integer, ByVal Original_Name As String, ByVal Original_Subject As String) As Integer
            If (Name Is Nothing) Then
